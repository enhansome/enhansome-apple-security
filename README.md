...
* [VX-Underground Malware Source Code](https://github.com/vxunderground/MalwareSourceCode) ⭐ 18,645 | 🐛 14 | 🌐 Assembly | 📅 2026-05-30 - Malware Sourcecode collection (various OS).
...
* [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 72,435 | 🐛 1,913 | 🌐 Java | 📅 2026-08-17 - A software reverse engineering (SRE) framework created and maintained by the National Security Agency Research Directorate.
* [Radare2](https://github.com/radareorg/radare2) ⭐ 24,586 | 🐛 818 | 🌐 C | 📅 2026-08-17 - UNIX-like reverse engineering framework and command-line toolset.
...
* [Frida](https://github.com/frida/frida) ⭐ 21,647 | 🐛 1,956 | 🌐 Meson | 📅 2026-08-16 - Dynamic instrumentation toolkit for developers, reverse-engineers, and security researchers.
...
* [iLEAPP](https://github.com/abrignoni/iLEAPP) ⭐ 1,152 | 🐛 61 | 🌐 Python | 📅 2026-08-17 - An iOS Logs, Events, And Plist Parser.
