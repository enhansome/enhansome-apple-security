...
* [mac\_apt](https://github.com/ydkhatri/mac_apt) ⭐ 1,076 | 🐛 8 | 🌐 Python | 📅 2026-08-21 - Plugin based forensics framework for quick mac triage that works on live machines, disk images or individual artifact files.
...
* [VX-Underground Malware Source Code](https://github.com/vxunderground/MalwareSourceCode) ⭐ 18,669 | 🐛 14 | 🌐 Assembly | 📅 2026-05-30 - Malware Sourcecode collection (various OS).
* [Objective-See Malware](https://github.com/objective-see/Malware) ⭐ 754 | 🐛 0 | 📅 2026-08-20 - Malware Collection by Patrick Wardle.
...
* [Process Tree](https://github.com/ydkhatri/mac_apt/tree/729630c8bbe7a73cce3ca330305d3301a919cb07) ⭐ 1,076 | 🐛 8 | 🌐 Python | 📅 2026-08-21 - Process tree Repository.
...
* [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 72,767 | 🐛 1,922 | 🌐 Java | 📅 2026-08-24 - A software reverse engineering (SRE) framework created and maintained by the National Security Agency Research Directorate.
...
* [Frida](https://github.com/frida/frida) ⭐ 21,730 | 🐛 1,959 | 🌐 Meson | 📅 2026-08-18 - Dynamic instrumentation toolkit for developers, reverse-engineers, and security researchers.
