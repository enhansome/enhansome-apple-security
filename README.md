...
* [mac\_apt](https://github.com/ydkhatri/mac_apt) ⭐ 1,078 | 🐛 8 | 🌐 Python | 📅 2026-08-21 - Plugin based forensics framework for quick mac triage that works on live machines, disk images or individual artifact files.
...
* [Process Tree](https://github.com/ydkhatri/mac_apt/tree/729630c8bbe7a73cce3ca330305d3301a919cb07) ⭐ 1,078 | 🐛 8 | 🌐 Python | 📅 2026-08-21 - Process tree Repository.
...
* [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 73,569 | 🐛 1,921 | 🌐 Java | 📅 2026-08-28 - A software reverse engineering (SRE) framework created and maintained by the National Security Agency Research Directorate.
* [Radare2](https://github.com/radareorg/radare2) ⭐ 24,674 | 🐛 827 | 🌐 C | 📅 2026-08-29 - UNIX-like reverse engineering framework and command-line toolset.
