...
* [VX-Underground Malware Source Code](https://github.com/vxunderground/MalwareSourceCode) ⭐ 18,731 | 🐛 14 | 🌐 Assembly | 📅 2026-05-30 - Malware Sourcecode collection (various OS).
* [Objective-See Malware](https://github.com/objective-see/Malware) ⭐ 774 | 🐛 0 | 📅 2026-08-20 - Malware Collection by Patrick Wardle.
...
* [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 77,569 | 🐛 1,961 | 🌐 Java | 📅 2026-09-15 - A software reverse engineering (SRE) framework created and maintained by the National Security Agency Research Directorate.
...
* [Frida](https://github.com/frida/frida) ⭐ 21,943 | 🐛 1,964 | 🌐 Meson | 📅 2026-09-16 - Dynamic instrumentation toolkit for developers, reverse-engineers, and security researchers.
...
* [unidbg](https://github.com/zhkl0228/unidbg) ⭐ 5,213 | 🐛 420 | 🌐 Java | 📅 2026-09-08 - Allows you to emulate an Android ARM32 and/or ARM64 native library, and an experimental iOS emulation.
...
* [iLEAPP](https://github.com/abrignoni/iLEAPP) ⭐ 1,270 | 🐛 63 | 🌐 Python | 📅 2026-09-14 - An iOS Logs, Events, And Plist Parser.
