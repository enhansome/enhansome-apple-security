...
* [mac\_apt](https://github.com/ydkhatri/mac_apt) ⭐ 1,075 | 🐛 10 | 🌐 Python | 📅 2026-08-21 - Plugin based forensics framework for quick mac triage that works on live machines, disk images or individual artifact files.
...
* [Objective-See Malware](https://github.com/objective-see/Malware) ⭐ 751 | 🐛 0 | 📅 2026-08-20 - Malware Collection by Patrick Wardle.
...
* [Process Tree](https://github.com/ydkhatri/mac_apt/tree/729630c8bbe7a73cce3ca330305d3301a919cb07) ⭐ 1,075 | 🐛 10 | 🌐 Python | 📅 2026-08-21 - Process tree Repository.
...
* [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 72,616 | 🐛 1,916 | 🌐 Java | 📅 2026-08-20 - A software reverse engineering (SRE) framework created and maintained by the National Security Agency Research Directorate.
* [Radare2](https://github.com/radareorg/radare2) ⭐ 24,612 | 🐛 822 | 🌐 C | 📅 2026-08-21 - UNIX-like reverse engineering framework and command-line toolset.
* [Cutter](https://github.com/rizinorg/cutter) ⭐ 19,484 | 🐛 493 | 🌐 C++ | 📅 2026-08-13 - Free and Open Source Reverse Engineering Platform powered by rizin.
...
* [objection](https://github.com/sensepost/objection) ⭐ 9,333 | 🐛 55 | 🌐 Python | 📅 2026-07-23 - A runtime mobile exploration toolkit, powered by Frida, built to help you assess the security posture of your mobile applications, without needing a jailbreak.
