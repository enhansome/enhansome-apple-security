...
* [Auditor](https://github.com/jipegit/OSXAuditor) ⭐ 3,133 | 🐛 8 | 🌐 JavaScript | 📅 2020-07-27 - Deprecated macOS DFIR tool for older systems.
* [Collector](https://github.com/yelp/osxcollector) ⚠️ Archived - macOS offshoot for live response.
* [mac\_apt](https://github.com/ydkhatri/mac_apt) ⭐ 1,081 | 🐛 8 | 🌐 Python | 📅 2026-08-21 - Plugin based forensics framework for quick mac triage that works on live machines, disk images or individual artifact files.
...
* [VX-Underground Malware Source Code](https://github.com/vxunderground/MalwareSourceCode) ⭐ 18,710 | 🐛 14 | 🌐 Assembly | 📅 2026-05-30 - Malware Sourcecode collection (various OS).
* [Objective-See Malware](https://github.com/objective-see/Malware) ⭐ 768 | 🐛 0 | 📅 2026-08-20 - Malware Collection by Patrick Wardle.
...
* [Process Tree](https://github.com/ydkhatri/mac_apt/tree/729630c8bbe7a73cce3ca330305d3301a919cb07) ⭐ 1,081 | 🐛 8 | 🌐 Python | 📅 2026-08-21 - Process tree Repository.
...
* [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 74,559 | 🐛 1,949 | 🌐 Java | 📅 2026-09-02 - A software reverse engineering (SRE) framework created and maintained by the National Security Agency Research Directorate.
* [Radare2](https://github.com/radareorg/radare2) ⭐ 24,752 | 🐛 821 | 🌐 C | 📅 2026-09-07 - UNIX-like reverse engineering framework and command-line toolset.
...
* [Frida](https://github.com/frida/frida) ⭐ 21,866 | 🐛 1,960 | 🌐 Meson | 📅 2026-09-07 - Dynamic instrumentation toolkit for developers, reverse-engineers, and security researchers.
...
* [unidbg](https://github.com/zhkl0228/unidbg) ⭐ 5,184 | 🐛 420 | 🌐 Java | 📅 2026-08-30 - Allows you to emulate an Android ARM32 and/or ARM64 native library, and an experimental iOS emulation.
...
* [iLEAPP](https://github.com/abrignoni/iLEAPP) ⭐ 1,188 | 🐛 62 | 🌐 Python | 📅 2026-09-07 - An iOS Logs, Events, And Plist Parser.
