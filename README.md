...
* [VX-Underground Malware Source Code](https://github.com/vxunderground/MalwareSourceCode) ⭐ 18,691 | 🐛 14 | 🌐 Assembly | 📅 2026-05-30 - Malware Sourcecode collection (various OS).
...
* [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 74,150 | 🐛 1,923 | 🌐 Java | 📅 2026-08-31 - A software reverse engineering (SRE) framework created and maintained by the National Security Agency Research Directorate.
* [Radare2](https://github.com/radareorg/radare2) ⭐ 24,692 | 🐛 825 | 🌐 C | 📅 2026-08-31 - UNIX-like reverse engineering framework and command-line toolset.
...
* [frida-gum](https://github.com/frida/frida-gum) ⭐ 1,013 | 🐛 208 | 🌐 C | 📅 2026-08-31 - Cross-platform instrumentation and introspection library written in C.
