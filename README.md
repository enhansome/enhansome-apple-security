...
* [mac\_apt](https://github.com/ydkhatri/mac_apt) ⭐ 1,073 | 🐛 7 | 🌐 Python | 📅 2026-07-23 - Plugin based forensics framework for quick mac triage that works on live machines, disk images or individual artifact files.
...
* [VX-Underground Malware Source Code](https://github.com/vxunderground/MalwareSourceCode) ⭐ 18,642 | 🐛 14 | 🌐 Assembly | 📅 2026-05-30 - Malware Sourcecode collection (various OS).
...
* [Process Tree](https://github.com/ydkhatri/mac_apt/tree/729630c8bbe7a73cce3ca330305d3301a919cb07) ⭐ 1,073 | 🐛 7 | 🌐 Python | 📅 2026-07-23 - Process tree Repository.
...
* [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 72,360 | 🐛 1,906 | 🌐 Java | 📅 2026-08-13 - A software reverse engineering (SRE) framework created and maintained by the National Security Agency Research Directorate.
...
* [unidbg](https://github.com/zhkl0228/unidbg) ⭐ 5,129 | 🐛 419 | 🌐 Java | 📅 2026-08-07 - Allows you to emulate an Android ARM32 and/or ARM64 native library, and an experimental iOS emulation.
