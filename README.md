...
* [Auditor](https://github.com/jipegit/OSXAuditor) ⭐ 3,132 | 🐛 8 | 🌐 JavaScript | 📅 2020-07-27 - Deprecated macOS DFIR tool for older systems.
* [Collector](https://github.com/yelp/osxcollector) ⚠️ Archived - macOS offshoot for live response.
* [mac\_apt](https://github.com/ydkhatri/mac_apt) ⭐ 1,081 | 🐛 9 | 🌐 Python | 📅 2026-08-21 - Plugin based forensics framework for quick mac triage that works on live machines, disk images or individual artifact files.
...
* [VX-Underground Malware Source Code](https://github.com/vxunderground/MalwareSourceCode) ⭐ 18,713 | 🐛 14 | 🌐 Assembly | 📅 2026-05-30 - Malware Sourcecode collection (various OS).
* [Objective-See Malware](https://github.com/objective-see/Malware) ⭐ 771 | 🐛 0 | 📅 2026-08-20 - Malware Collection by Patrick Wardle.
...
* [Process Tree](https://github.com/ydkhatri/mac_apt/tree/729630c8bbe7a73cce3ca330305d3301a919cb07) ⭐ 1,081 | 🐛 9 | 🌐 Python | 📅 2026-08-21 - Process tree Repository.
...
* [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 74,761 | 🐛 1,947 | 🌐 Java | 📅 2026-09-08 - A software reverse engineering (SRE) framework created and maintained by the National Security Agency Research Directorate.
* [Radare2](https://github.com/radareorg/radare2) ⭐ 24,776 | 🐛 819 | 🌐 C | 📅 2026-09-10 - UNIX-like reverse engineering framework and command-line toolset.
...
* [Frida](https://github.com/frida/frida) ⭐ 21,879 | 🐛 1,962 | 🌐 Meson | 📅 2026-09-09 - Dynamic instrumentation toolkit for developers, reverse-engineers, and security researchers.
...
* [unidbg](https://github.com/zhkl0228/unidbg) ⭐ 5,198 | 🐛 420 | 🌐 Java | 📅 2026-09-08 - Allows you to emulate an Android ARM32 and/or ARM64 native library, and an experimental iOS emulation.
...
* [iLEAPP](https://github.com/abrignoni/iLEAPP) ⭐ 1,190 | 🐛 61 | 🌐 Python | 📅 2026-09-10 - An iOS Logs, Events, And Plist Parser.
