...
* [mac\_apt](https://github.com/ydkhatri/mac_apt) ⭐ 1,074 | 🐛 7 | 🌐 Python | 📅 2026-07-23 - Plugin based forensics framework for quick mac triage that works on live machines, disk images or individual artifact files.
...
* [VX-Underground Malware Source Code](https://github.com/vxunderground/MalwareSourceCode) ⭐ 18,644 | 🐛 14 | 🌐 Assembly | 📅 2026-05-30 - Malware Sourcecode collection (various OS).
* [Objective-See Malware](https://github.com/objective-see/Malware) ⭐ 744 | 🐛 0 | 📅 2026-08-13 - Malware Collection by Patrick Wardle.
...
* [Process Tree](https://github.com/ydkhatri/mac_apt/tree/729630c8bbe7a73cce3ca330305d3301a919cb07) ⭐ 1,074 | 🐛 7 | 🌐 Python | 📅 2026-07-23 - Process tree Repository.
...
* [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 72,367 | 🐛 1,908 | 🌐 Java | 📅 2026-08-13 - A software reverse engineering (SRE) framework created and maintained by the National Security Agency Research Directorate.
* [Radare2](https://github.com/radareorg/radare2) ⭐ 24,573 | 🐛 821 | 🌐 C | 📅 2026-08-15 - UNIX-like reverse engineering framework and command-line toolset.
...
* [Frida](https://github.com/frida/frida) ⭐ 21,631 | 🐛 1,956 | 🌐 Meson | 📅 2026-08-13 - Dynamic instrumentation toolkit for developers, reverse-engineers, and security researchers.
