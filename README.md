...
* [Auditor](https://github.com/jipegit/OSXAuditor) ⭐ 3,132 | 🐛 9 | 🌐 JavaScript | 📅 2020-07-27 - Deprecated macOS DFIR tool for older systems.
* [Collector](https://github.com/yelp/osxcollector) ⚠️ Archived - macOS offshoot for live response.
* [mac\_apt](https://github.com/ydkhatri/mac_apt) ⭐ 1,086 | 🐛 9 | 🌐 Python | 📅 2026-08-21 - Plugin based forensics framework for quick mac triage that works on live machines, disk images or individual artifact files.
...
* [VX-Underground Malware Source Code](https://github.com/vxunderground/MalwareSourceCode) ⭐ 18,745 | 🐛 14 | 🌐 Assembly | 📅 2026-05-30 - Malware Sourcecode collection (various OS).
* [Objective-See Malware](https://github.com/objective-see/Malware) ⭐ 779 | 🐛 0 | 📅 2026-08-20 - Malware Collection by Patrick Wardle.
...
* [Process Tree](https://github.com/ydkhatri/mac_apt/tree/729630c8bbe7a73cce3ca330305d3301a919cb07) ⭐ 1,086 | 🐛 9 | 🌐 Python | 📅 2026-08-21 - Process tree Repository.
...
* [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 79,572 | 🐛 1,955 | 🌐 Java | 📅 2026-09-24 - A software reverse engineering (SRE) framework created and maintained by the National Security Agency Research Directorate.
* [Radare2](https://github.com/radareorg/radare2) ⭐ 24,867 | 🐛 821 | 🌐 C | 📅 2026-09-24 - UNIX-like reverse engineering framework and command-line toolset.
* [Cutter](https://github.com/rizinorg/cutter) ⭐ 19,800 | 🐛 495 | 🌐 C++ | 📅 2026-09-11 - Free and Open Source Reverse Engineering Platform powered by rizin.
...
* [Frida](https://github.com/frida/frida) ⭐ 22,024 | 🐛 1,964 | 🌐 Meson | 📅 2026-09-22 - Dynamic instrumentation toolkit for developers, reverse-engineers, and security researchers.
* [objection](https://github.com/sensepost/objection) ⭐ 9,403 | 🐛 58 | 🌐 Python | 📅 2026-09-17 - A runtime mobile exploration toolkit, powered by Frida, built to help you assess the security posture of your mobile applications, without needing a jailbreak.
...
* [MacOS-Full-Disk-Access-Tunnel](https://github.com/civillizard/MacOS-Full-Disk-Access-Tunnel) ⭐ 1 | 🐛 0 | 🌐 Shell | 📅 2026-04-17 - Grant Full Disk Access to interpreter binaries (Python, Node, Ruby) so launchd and cron scripts can read TCC-protected data like Safari history, cookies, and Photos metadata.
