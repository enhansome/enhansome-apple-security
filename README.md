...
* [VX-Underground Malware Source Code](https://github.com/vxunderground/MalwareSourceCode) ⭐ 18,716 | 🐛 14 | 🌐 Assembly | 📅 2026-05-30 - Malware Sourcecode collection (various OS).
...
* [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 74,816 | 🐛 1,942 | 🌐 Java | 📅 2026-09-11 - A software reverse engineering (SRE) framework created and maintained by the National Security Agency Research Directorate.
* [Radare2](https://github.com/radareorg/radare2) ⭐ 24,779 | 🐛 824 | 🌐 C | 📅 2026-09-11 - UNIX-like reverse engineering framework and command-line toolset.
...
* [Frida](https://github.com/frida/frida) ⭐ 21,891 | 🐛 1,962 | 🌐 Meson | 📅 2026-09-09 - Dynamic instrumentation toolkit for developers, reverse-engineers, and security researchers.
...
* [unidbg](https://github.com/zhkl0228/unidbg) ⭐ 5,202 | 🐛 420 | 🌐 Java | 📅 2026-09-08 - Allows you to emulate an Android ARM32 and/or ARM64 native library, and an experimental iOS emulation.
...
* [iLEAPP](https://github.com/abrignoni/iLEAPP) ⭐ 1,220 | 🐛 62 | 🌐 Python | 📅 2026-09-10 - An iOS Logs, Events, And Plist Parser.
