...
* [mac\_apt](https://github.com/ydkhatri/mac_apt) ⭐ 1,072 | 🐛 7 | 🌐 Python | 📅 2026-07-23 - Plugin based forensics framework for quick mac triage that works on live machines, disk images or individual artifact files.
...
* [VX-Underground Malware Source Code](https://github.com/vxunderground/MalwareSourceCode) ⭐ 18,638 | 🐛 14 | 🌐 Assembly | 📅 2026-05-30 - Malware Sourcecode collection (various OS).
* [Objective-See Malware](https://github.com/objective-see/Malware) ⭐ 744 | 🐛 0 | 📅 2026-08-10 - Malware Collection by Patrick Wardle.
...
* [Process Tree](https://github.com/ydkhatri/mac_apt/tree/729630c8bbe7a73cce3ca330305d3301a919cb07) ⭐ 1,072 | 🐛 7 | 🌐 Python | 📅 2026-07-23 - Process tree Repository.
...
* [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 72,317 | 🐛 1,912 | 🌐 Java | 📅 2026-08-10 - A software reverse engineering (SRE) framework created and maintained by the National Security Agency Research Directorate.
* [Radare2](https://github.com/radareorg/radare2) ⭐ 24,563 | 🐛 822 | 🌐 C | 📅 2026-08-13 - UNIX-like reverse engineering framework and command-line toolset.
* [Cutter](https://github.com/rizinorg/cutter) ⭐ 19,459 | 🐛 492 | 🌐 C++ | 📅 2026-08-03 - Free and Open Source Reverse Engineering Platform powered by rizin.
...
* [Frida](https://github.com/frida/frida) ⭐ 21,620 | 🐛 1,956 | 🌐 Meson | 📅 2026-08-13 - Dynamic instrumentation toolkit for developers, reverse-engineers, and security researchers.
...
* [unidbg](https://github.com/zhkl0228/unidbg) ⭐ 5,126 | 🐛 419 | 🌐 Java | 📅 2026-08-07 - Allows you to emulate an Android ARM32 and/or ARM64 native library, and an experimental iOS emulation.
