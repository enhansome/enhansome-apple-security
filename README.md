...
* [mac\_apt](https://github.com/ydkhatri/mac_apt) ⭐ 1,075 | 🐛 8 | 🌐 Python | 📅 2026-07-23 - Plugin based forensics framework for quick mac triage that works on live machines, disk images or individual artifact files.
...
* [VX-Underground Malware Source Code](https://github.com/vxunderground/MalwareSourceCode) ⭐ 18,651 | 🐛 14 | 🌐 Assembly | 📅 2026-05-30 - Malware Sourcecode collection (various OS).
* [Objective-See Malware](https://github.com/objective-see/Malware) ⭐ 745 | 🐛 0 | 📅 2026-08-13 - Malware Collection by Patrick Wardle.
...
* [PersistentJXA](https://github.com/D00MFist/PersistentJXA) ⭐ 290 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-26 - Collection of macOS persistence methods in JXA.
...
* [Process Tree](https://github.com/ydkhatri/mac_apt/tree/729630c8bbe7a73cce3ca330305d3301a919cb07) ⭐ 1,075 | 🐛 8 | 🌐 Python | 📅 2026-07-23 - Process tree Repository.
...
* [VOODOO](https://github.com/breakpointHQ/VOODOO) ⭐ 51 | 🐛 0 | 🌐 Ruby | 📅 2024-12-24 - Browser Attack Framework for macOS.
* [Mythic C2](https://docs.mythic-c2.net/) - Mythic C2 Framework Documentation.

### Reverse Engineering Tools

* [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 72,479 | 🐛 1,913 | 🌐 Java | 📅 2026-08-17 - A software reverse engineering (SRE) framework created and maintained by the National Security Agency Research Directorate.
* [Radare2](https://github.com/radareorg/radare2) ⭐ 24,590 | 🐛 823 | 🌐 C | 📅 2026-08-18 - UNIX-like reverse engineering framework and command-line toolset.
...
* [Frida](https://github.com/frida/frida) ⭐ 21,661 | 🐛 1,957 | 🌐 Meson | 📅 2026-08-18 - Dynamic instrumentation toolkit for developers, reverse-engineers, and security researchers.
* [objection](https://github.com/sensepost/objection) ⭐ 9,322 | 🐛 55 | 🌐 Python | 📅 2026-07-23 - A runtime mobile exploration toolkit, powered by Frida, built to help you assess the security posture of your mobile applications, without needing a jailbreak.
...
* [unidbg](https://github.com/zhkl0228/unidbg) ⭐ 5,140 | 🐛 419 | 🌐 Java | 📅 2026-08-07 - Allows you to emulate an Android ARM32 and/or ARM64 native library, and an experimental iOS emulation.
